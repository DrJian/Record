...
Confluence.Templates.Pagetree.Macro.loadingIndicator = function(opt_data, opt_sb) {
  ...
  output.append('<div class="plugin_pagetree_children_loading_wrapper"><div class="spinner"/><span class="plugin_pagetree_children_loading">', soy.$$escapeHtml("\u8f7d\u5165\u4e2d..."), '</span></div>');
...
Confluence.Templates.User.logo = function(opt_data, opt_sb) {
  ...
  if (opt_data.profilePictureInfo['default'] && opt_data.username == opt_data.currentUsername) {
    output.append('<a ', (opt_data.canView) ? ' ' + ((! opt_data.disableUserHover) ? 'class="userLogoLink"' : '') + ' data-username="' + soy.$$escapeHtml(opt_data.username) + '"' : '', ' href="', soy.$$escapeHtml(""), '/users/editmyprofilepicture.action" title="', soy.$$escapeHtml("\u6dfb\u52a0\u5934\u50cf"), '"><img class="userLogo logo defaultLogo" src="', soy.$$escapeHtml("/s/zh_CN/5528/d86f1e458384da85f007b276ccfa37b0b9acccac.16/_"), '/images/icons/profilepics/add_profile_pic.png" alt="', soy.$$escapeHtml("\u7528\u6237\u56fe\u6807"), ': ', soy.$$escapeHtml("\u6dfb\u52a0\u5934\u50cf"), '"></a>');
  } else {
    if (opt_data.profilePictureInfo.anonymous) {
      output.append('<img class="userLogo logo anonymous" src="', soy.$$escapeHtml("/s/zh_CN/5528/d86f1e458384da85f007b276ccfa37b0b9acccac.16/_"), '/images/icons/profilepics/anonymous.png" alt="', soy.$$escapeHtml("\u7528\u6237\u56fe\u6807"), ': ', soy.$$escapeHtml("\u533f\u540d"), '" title="', soy.$$escapeHtml("\u533f\u540d"), '">');
      ...
      output.append('<img class="userLogo logo anonymous" src="', soy.$$escapeHtml("/s/zh_CN/5528/d86f1e458384da85f007b276ccfa37b0b9acccac.16/_"), '/images/icons/profilepics/anonymous.png" alt="', soy.$$escapeHtml("\u7528\u6237\u56fe\u6807"), ': ', soy.$$escapeHtml(opt_data.username), '" title="', soy.$$escapeHtml(opt_data.username), '">');
    }
  }
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.Comments.userLogo = function(opt_data, opt_sb) {
  ...
  if (opt_data.userInfo.userName == null) {
    ...
    output.append('<a class="userLogoLink" data-username="', soy.$$escapeHtml(opt_data.userInfo.userName), '" href="', soy.$$escapeHtml(""), '/users/editmyprofilepicture.action" title="', soy.$$escapeHtml("\u6dfb\u52a0\u5934\u50cf"), '"><img class="userLogo logo defaultLogo" src="', soy.$$escapeHtml("/s/zh_CN/5528/d86f1e458384da85f007b276ccfa37b0b9acccac.16/_"), '/images/icons/profilepics/add_profile_pic.png" alt="', soy.$$escapeHtml("\u7528\u6237\u56fe\u6807"), ': ', soy.$$escapeHtml("\u6dfb\u52a0\u5934\u50cf"), '"></a>');
  } else {
...
Confluence.QuickReload=Confluence.QuickReload||{};AJS.toInit(function(a){Confluence.QuickReload.Page=function(){return{property:"page",singleText:function(c,b){return AJS.format("\u7531{0}\u65B0\u4FEE\u6539",b(c.editor))},manyText:function(b){return AJS.format("{0} \u4E2A\u65B0\u4FEE\u6539\u9879",b.length)},showText:function(){return "\u91CD\u65B0\u52A0\u8F7D"},filterNewResults:function(b,c){return c},update:function(b){window.location.reload()}}}});
} catch (err) {
    if (console && console.log && console.error) {
        console.log("Error running batched script.");
        console.error(err);
...
Confluence.Templates.Metadata.JIRA.metadata = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div id="jira-metadata-dialog" class="rendered-content"><h2 class="title">', soy.$$escapeHtml("JIRA\u94fe\u63a5"), '</h2><div class="items-section">');
...
Confluence.Templates.Metadata.JIRA.featureDiscovery = function(opt_data, opt_sb) {
  ...
  aui.buttons.button({text: "\u4e0d\u8981\u518d\u663e\u793a", type: 'link', extraClasses: 'close'}, output);
  output.append('</div></div></div>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.Metadata.JIRA.renderJiraErrors = function(opt_data, opt_sb) {
  ...
  if (opt_data.errors.length == 1) {
    ...
    var param159 = new soy.StringBuilder('<p>', soy.$$escapeHtml("\u4e0d\u80fd\u83b7\u53d6JIRA\u5143\u6570\u636e\u4fe1\u606f\uff0c\u53d1\u751f\u4e86\u4ee5\u4e0b\u9519\u8bef:"), '</p><ul>');
...
jiraIntegration.templates.fields.labelFieldResult = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append((opt_data.label.isNew) ? soy.$$escapeHtml(AJS.format("\x22{0}\x22 - (\u65b0\u6807\u7b7e)",opt_data.label.labelName)) : soy.$$escapeHtml(opt_data.label.labelName));
  return opt_sb ? '' : output.toString();
};
...
Confluence.CreateJiraContent.buildFieldList = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  var joinText__soy45 = new soy.StringBuilder((opt_data.fields.length == 2) ? ' ' + soy.$$escapeHtml("\u548c") + ' ' : ', ');
...
Confluence.InlineTasks.Templates.notice = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div class="aui-message error', (opt_data.className) ? ' ' + soy.$$escapeHtml(opt_data.className) : '', '" id="inline-tasks-notice">', opt_data.textMessage, '&nbsp;&nbsp;<a href="#" class="notice-close">', soy.$$escapeHtml("\u4e0d\u518d\u63d0\u793a"), '</a></div>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.UI.Components.Pagination.Templates.paginationFooter = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<ol class="aui-nav aui-nav-pagination macro-auto-pagination" data-page-size="', soy.$$escapeHtml(opt_data.pageSize), '" data-initial-page-index="', soy.$$escapeHtml(opt_data.currentPage), '"><li class="aui-nav-previous"><a href="#"', (opt_data.currentPage == 0) ? 'aria-disabled="true"' : '', '>', soy.$$escapeHtml("\u524d"), '</a></li>');
  ...
  output.append('<li class="aui-nav-next"><a href="', soy.$$escapeHtml(opt_data.url), '"', (currentIdx__soy15 == opt_data.totalPages) ? 'aria-disabled="true"' : '', '>', soy.$$escapeHtml("\u4e0b\u4e00\u6b65"), '</a></li></ol>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.InlineTasks.Report.Templates.tasksFeatureDiscoveryNotification = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<h2>', soy.$$escapeHtml("\u563f\uff01\u4f60\u77e5\u9053......"), '</h2><p>', soy.$$escapeHtml("You can view the tasks you created, or assigned to you, in the tasks tabs of your profile."), '</p>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.InlineTasks.Report.Templates.taskReportBrowserWarning = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  var param97 = new soy.StringBuilder('<p>', soy.$$escapeHtml("\u65e0\u6cd5\u663e\u793a\u6b64\u4efb\u52a1\u62a5\u544a\u3002"), '</p>');
...
AJS.Templates.HelpTip.tipContent = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append((opt_data.title) ? '<h4 class="helptip-title">' + soy.$$escapeHtml(opt_data.title) + '</h4>' : '', '<div class="helptip-body">', opt_data.bodyHtml, '</div>', (opt_data.url) ? '<a class="helptip-link" href="' + soy.$$escapeHtml(opt_data.url) + '" target="_blank">' + soy.$$escapeHtml("\u4e86\u89e3\u66f4\u591a") + '</a>' : '');
  return opt_sb ? '' : output.toString();
};
...
AJS.Templates.HelpTip.tipDismiss = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<button class="helptip-dismiss aui-button" type="button">', soy.$$escapeHtml("\u4e0d\u518d\u63d0\u793a"), '</button>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.Likes.likesDialog = function(opt_data, opt_sb) {
  ...
  for (var likeIndex20 = 0; likeIndex20 < likeListLen20; likeIndex20++) {
    ...
    output.append('<li><div class="avatar-container"><a href="', soy.$$escapeHtml(likeData20.user.url), '"><img class="like-user-avatar" src="', soy.$$escapeHtml(likeData20.user.avatarUrl), '"></a></div><div class="like-user"><a class="like-user-link" href="', soy.$$escapeHtml(likeData20.user.url), '">', soy.$$escapeHtml(likeData20.user.fullName), '</a></div><div class="follow-button-container aui-toolbar"><ul class="toolbar-group"><li class="toolbar-item">', (likeData20.user.followedByRemoteUser) ? soy.$$escapeHtml("\u8ffd\u968f") : (opt_data.remoteUser && opt_data.remoteUser.length > 0) ? '<button data-username="' + soy.$$escapeHtml(likeData20.user.name) + '" class="likes-dialog-follow-button toolbar-trigger">' + soy.$$escapeHtml("\u8ffd\u968f") + '</button>' : '', '</li></ul></div></li>');
  }
...
Confluence.Blueprints.JiraReports.Dialog.selectreport = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div class="template-select-container-body loadable"><div class="warningAppLink"></div><ol id="jirareports-select-type" class="jirareports-templates"><li class="template" id="jirareports-select-changelog"><img class="template-preview" src="', soy.$$escapeHtml(""), '/download/resources/com.atlassian.confluence.plugins.confluence-software-blueprints:jirareports-resources/icon-changelog-48.png"><div class="template-meta"><div class="template-name">', soy.$$escapeHtml("\u66f4\u6539\u65e5\u5fd7"), '</div><div class="template-description">', soy.$$escapeHtml("Create a report with a list of JIRA issues for a project, release or specific query."), '</div></div></li><li class="template" id="jirareports-select-statusreport"><img class="template-preview" src="', soy.$$escapeHtml(""), '/download/resources/com.atlassian.confluence.plugins.confluence-software-blueprints:jirareports-resources/icon-statusreport-48.png"><div class="template-meta"><div class="template-name">', soy.$$escapeHtml("\u72b6\u6001\u62a5\u544a"), '</div><div class="template-description">', soy.$$escapeHtml("Create a report with charts to communicate the status of your release with stakeholders."), '</div></div></li></ol></div>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.InlineTasks.Report.Templates.reportByLocationForm = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<form action="#" method="post" id="report-by-location-form" class="aui"><fieldset><div class="field-group"><label for="task-report-page-title">', soy.$$escapeHtml("Title"), '<span class="aui-icon icon-required">required</span></label><input id="task-report-page-title" class="text long-field" type="text" name="title" placeholder="', soy.$$escapeHtml("\u4efb\u52a1\u62a5\u544a\u6807\u9898"), '"/><div class="error hidden"></div></div><div class="field-group"><label for="task-report-location-picker">', soy.$$escapeHtml("\u521b\u5efa\u5728"), '<span class="aui-icon icon-required">required</span></label><input id="task-report-location-picker" class="text select2-input long-field" type="text" name="locations" placeholder="', soy.$$escapeHtml("Select task locations"), '"/><div class="error hidden"></div></div><div class="field-group"><label for="task-report-label-picker">', soy.$$escapeHtml("Labels"), '</label><input id="task-report-label-picker" class="text select2-input long-field" type="text" name="labels" placeholder="', soy.$$escapeHtml("\u4ec5\u5217\u51fa\u9875\u9762\u4e0a\u6709\u8fd9\u4e9b\u6807\u7b7e\u7684\u4efb\u52a1"), '"/></div><div class="field-group"><div class="checkbox"><input class="checkbox" type="checkbox" name="completed" id="task-report-completed-cb"><label for="task-report-completed-cb">', soy.$$escapeHtml("Include completed tasks"), '</label></div></div></fieldset></form>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.InlineTasks.Report.Templates.teamReportContent = function(opt_data, opt_sb) {
  ...
  if (opt_data.showCompletedTasks) {
    output.append('<ac:structured-macro ac:name="expand"><ac:parameter ac:name="title">', soy.$$escapeHtml("\u5df2\u5b8c\u6210\u7684\u4efb\u52a1"), '</ac:parameter><ac:rich-text-body><p><ac:structured-macro ac:name="tasks-report-macro"><!-- assignee-->');
    Confluence.InlineTasks.Report.Templates.assigneeParam({userKeys: opt_data.assignees}, output);
...
Confluence.InlineTasks.Report.Templates.locationReportContent = function(opt_data, opt_sb) {
  ...
  output.append('<!-- status--><ac:parameter ac:name="status">incomplete</ac:parameter></ac:structured-macro></p>');
  if (opt_data.showCompletedTasks) {
    output.append('<ac:structured-macro ac:name="expand"><ac:parameter ac:name="title">', soy.$$escapeHtml("\u5df2\u5b8c\u6210\u7684\u4efb\u52a1"), '</ac:parameter><ac:rich-text-body><p><ac:structured-macro ac:name="tasks-report-macro"><!-- space-->');
    Confluence.InlineTasks.Report.Templates.macroParam({name: 'spaces', value: opt_data.spaceKeys}, output);
    output.append('<!-- pages-->');
    Confluence.InlineTasks.Report.Templates.macroParam({name: 'pages', value: opt_data.pageIds}, output);
    output.append('<!-- labels-->');
...
(function(d){var c;function e(t){t.addClass("selected").siblings().removeClass("selected");AJS.trigger("selected.task-report-types",t)}function i(w,v){AJS.Analytics?AJS.Analytics.triggerPrivacyPolicySafeEvent("confluence-spaces.tasks.report_blueprint.clicked"):AJS.trigger("analyticsEvent",{name:"confluence-spaces.tasks.report_blueprint.clicked"});var u=d("#task-report-types");var t=u.find(".template");t.first().addClass("selected");t.click(function(){e(d(this))}).dblclick(function(){d(".create-dialog-create-button:visible").click()});u.attr("tabindex",0).keydown(function(z){if(z.keyCode==38||z.keyCode==40){z.preventDefault();var x=u.find(".selected"),y;if(z.keyCode==38){y=x.prev().length?x.prev():t.last()}else{if(z.keyCode==40){y=x.next().length?x.next():t.first()}}e(y)}});u.focus();AJS.bind("selected.task-report-types",function(y,x){if(d(x).is("#custom-task-report")){p("\u521B\u5EFA")}else{p("\u4E0B\u4E00\u6B65")}});p("Next")}function f(v,u){var t=u.$container.find(".selected").attr("id");if(t==="team-task-report"){u.nextPageId="teamTaskReportId";AJS.Analytics?AJS.Analytics.triggerPrivacyPolicySafeEvent("confluence-spaces.tasks.report_team.clicked"):AJS.trigger("analyticsEvent",{name:"confluence-spaces.tasks.report_team.clicked"})}else{if(t==="location-task-report"){u.nextPageId="locationTaskReportId";AJS.Analytics?AJS.Analytics.triggerPrivacyPolicySafeEvent("confluence-spaces.tasks.report_project.clicked"):AJS.trigger("analyticsEvent",{name:"confluence-spaces.tasks.report_project.clicked"})}else{if(t==="custom-task-report"){c.getSubmissionRestPath=function(){AJS.Analytics?AJS.Analytics.triggerPrivacyPolicySafeEvent("confluence-spaces.tasks.report_custom.clicked"):AJS.trigger("analyticsEvent",{name:"confluence-spaces.tasks.report_custom.clicked"});return"/rest/create-dialog/1.0/content-blueprint/create-draft"};g(u,"custom-task-report-template")}else{return false}}}}function a(u,t){o()}function m(w,v){var t=d("#report-by-team-form");b(t);var u=true;u=r(d("#task-report-team-picker"),"\u9700\u8981\u6307\u6D3E\u4EBA\u3002")&&u;u=s(v.wizardData.spaceKey)&&u;u?g(v,"team-task-report-template"):h(t);AJS.Analytics?AJS.Analytics.triggerPrivacyPolicySafeEvent("confluence-spaces.tasks.report_team.created"):AJS.trigger("analyticsEvent",{name:"confluence-spaces.tasks.report_team.created"});return u}function n(u,t){k(d("#task-report-location-picker"),t.wizardData.spaceKey);q(d("#task-report-label-picker"));o()}function j(w,v){var t=d("#report-by-location-form");b(t);var u=true;u=r(d("#task-report-location-picker"),"\u9700\u8981\u4E00\u4E2A\u7A7A\u95F4\u6216\u9875\u9762\u3002")&&u;u=s(v.wizardData.spaceKey)&&u;if(u){g(v,"location-task-report-template")}else{h(t)}AJS.Analytics?AJS.Analytics.triggerPrivacyPolicySafeEvent("confluence-spaces.tasks.report_project.created"):AJS.trigger("analyticsEvent",{name:"confluence-spaces.tasks.report_project.created"});return u}Confluence.Blueprint.setWizard("com.atlassian.confluence.plugins.confluence-inline-tasks:task-report-blueprint-item",function(t){t.on("post-render.selectTaskReportId",i);t.on("submit.selectTaskReportId",f);t.on("post-render.teamTaskReportId",a);t.on("submit.teamTaskReportId",m);t.on("post-render.locationTaskReportId",n);t.on("submit.locationTaskReportId",j);c=t});function b(t){t.find(".error").addClass("hidden").empty()}function s(v){var t=d("#task-report-page-title");var u=Confluence.Blueprint.validateTitle(t,v);if(!u){t.siblings(".error").removeClass("hidden")}return u}function r(t,u){var v=d.trim(t.val());if(!v&&u){l(t,u)}return !!v}function h(u){var t=u.find("div.error:not(.hidden)").first();var v=t.siblings("input").eq(0);if(v.hasClass("select2-offscreen")){v.select2("focus")}else{v.focus()}}function g(t,u){t.pageData.contentTemplateKey=u}function l(v,u){var t=v.siblings(".error");t.html(u);t.removeClass("hidden");return u}function q(t){t.auiSelect2(Confluence.UI.Components.LabelPicker.build())}function k(u,t){u.auiSelect2(Confluence.UI.Components.SpacePagePicker.build({spaceKeys:[t],orgElement:u}))}function p(t){d(".create-dialog-create-button:visible").text(t)}function o(){var v;var u=d("#task-report-completed-cb");var t=d("label[for=task-report-completed-cb]").add(u);t.mousedown(function(){v=true});d(".dialog-wizard-page-main").on("mouseup",function(w){if(!t.is(w.target)&&v){u.click()}v=false})}})(AJS.$);
} catch (err) {
    if (console && console.log && console.error) {
        console.log("Error running batched script.");
        console.error(err);
...
(function($){
    ...
    function triggerAnalytics(action) {
        AJS.trigger('analyticsEvent', { name: 'rte.quick-edit.' + action });
    }
    ...
    $(function(){
        ...
        if (!AJS.DarkFeatures.isEnabled('shipit25.quick.edit.defer')) {
    ...
    AJS.Confluence.QuickEdit = {
        ...
        /**
         * @deprecated This method and some of the functionality of quick-edit is going to change in 5.6
         *
         ...
         * @param loadedCallback callback function to be called when the editor gets loaded successfully
         * @param fallbackUrl the url presented to the user if there is an error activating the editor
         */
        activateEditor: function($container, saveHandler, cancelHandler, transition, fallbackUrl, loadedCallback) {
            var $form = $container.find(".quick-comment-form"); // initially the quick-comment placeholder, afterwards the quick-comment editor
            var $loadingContainer = $container.find(".quick-comment-loading-container"); // the big grey comment-shaped box

            // Prevent multiple activation (e.g. due to popstate events fired by Chrome)
            if(activated) {
                AJS.trigger('analyticsEvent', {name: 'rte.quick-edit.editor-already-activated' });
                return;
            }
            ...
            if(!$form.length) {
                ...
                AJS.logError('Editor form cannot be found - defaulting to normal edit');
                triggerAnalytics ('bad-page');
                window.location = fallbackUrl;
                return;
            }

            var completeTransitionSuccessfullyFn;

            // be able to "record" and then replay buffered keys while the transition is taking place.
            var replayBufferedKeys = AJS.Confluence.BlockAndBuffer.block($(document));
            ...
            var successCallback = function() {
                completeTransitionSuccessfullyFn();

                cancelTimeoutMessage();

                $loadingContainer.hide(); // hide the placeholder if is shown
                ...
                $form.fadeIn("fast", function() {
                    ...
                    setEditorText(replayBufferedKeys());
                    ...
                    loadedCallback && loadedCallback(AJS.Rte.getEditor());
                });
            ...
            var timeoutCallback = function() {
                triggerAnalytics ('loading.timeout');
                AJS.logError('quick edit timeout. loading fallbackUrl...');
                window.location = fallbackUrl;
            };

            var errorCallback = function(message) {
                triggerAnalytics ('loading.failed');
                AJS.logError('quick edit error. loading fallbackUrl...');
                window.location = fallbackUrl;
            };

            var errorTimeoutId = setTimeout(timeoutCallback,
                AJS.Confluence.EditorLoader.loadingTimeout);


            // activate editor and handle promise returned
            var editorActivationPromise = AJS.Confluence.EditorLoader.activate($form);

            editorActivationPromise.progress(function(){
                // this is only called on first activation callback,
                // what happens when the resources have been loaded
                completeTransitionSuccessfullyFn = transition($form, $loadingContainer);
            });

            editorActivationPromise.done(successCallback);

            editorActivationPromise.fail(errorCallback);
            ...
            editorActivationPromise.done(function () {
...
(function($) {
    ...
    QuickEdit.QuickComment = {
         ...
         */
        loadingTransition: function($form, $loadingContainer) {
            ...
            return function finishTransitionSuccessfully() {
...
(function($){
    ...
    /**
     * Callback executed when the editor gets loaded successfully in the comment top-level placeholder
     */
    ...
    var topLevelHandler = {
        ...
        activateEventHandler: function(e) {
            ...
            return QuickEdit.activateEditor($container, saveHandler, QuickComment.cancelHandler, topLevelHandler.loadingTransition, fallbackUrl, editorLoaded);
        },
         ...
         */
        loadingTransition: function($form, $loadingContainer) {
            return QuickComment.loadingTransition($form, $loadingContainer);
        }
    };
...
(function($){
    ...
    /**
     * Callback executed when the editor gets loaded successfully in the reply placeholder
     */
    function editorLoaded(ed){
    ...
    var replyHandler = {
        ...
        activateEventHandler: function(e) {
            ...
            QuickEdit.activateEditor($container, saveHandler, QuickComment.cancelHandler, replyHandler.loadingTransition, fallbackUrl, editorLoaded);
            e.stopPropagation();
            return false;
        },
         ...
         */
        loadingTransition: function($form, $loadingContainer) {
            var cancelLoadingMessage = QuickComment.loadingTransition($form, $loadingContainer);
            var $container = $loadingContainer.closest(".quick-comment-container");
            $container.scrollWindowToElement(); //use scroll-util jquery plugin
            $('.bottom-comment-panels').fadeOut(); // hide top level comment
...
(function ($) {
    ...
    function saveHandler(e) {
        ...
        AJS.debug('Quick Edit page save.');
    }

    function cancelHandler() {
        //No need for implementation, it's just a link.
        AJS.debug('Quick Edit cancel.');
    }

    function showEditSpinner() {
        var $editPageLink = $('#editPageLink');
        $editPageLink.removeClass('edit');
        $editPageLink.parent().spin({ left: '10px'});
    }

    /**
     * Callback executed when the editor gets loaded successfully in the page
     */
    function editorLoaded (ed){
    ...
    function loadingTransition(form) {
        ...
        return function finishTransitionSuccessfully() {
            ...
            var failure = function () {
                AJS.trigger('analyticsEvent', {name: 'rte.quick-edit.loading-page-content.failure' });
            ...
            xhr.success(function (data) {
                ...
                AJS.trigger('analyticsEvent', {name: 'rte.quick-edit.loading-page-content.success' });
            });
            xhr.error(failure);
        };
    }
    ...
    var QuickPageEdit = {
        ...
        activateEventHandler:function (e) {
            ...
            function loadEditor(){
                AJS.Confluence.QuickEdit.activateEditor(container, saveHandler, cancelHandler, loadingTransition, fallbackUrl, editorLoaded);
            }

            showEditSpinner();

            if (AJS.DarkFeatures.isEnabled('shipit25.quick.edit.defer')) {
                // defer editor resource loading until we actually load the editor, so we don't have the overhead of
                // asset loading in every single view page.
                AJS.Confluence.EditorLoader.load(loadEditor);
            }
            else {
                loadEditor();
            }
        ...
        activateEditor: function() {
            AJS.Confluence.QuickEdit.activateEditor(container, saveHandler, cancelHandler, loadingTransition, "", editorLoaded);
        },
            ...
            if ((supportsPushState && history.state && history.state.quickEdit)
                ...
                if (message) {
                    ...
                    if(confirm(message + "\n\n "+ "\u70B9\u51FB\u201C\u786E\u5B9A\u201D\u7EE7\u7EED\uFF0C\u6216\u8005\u201C\u53D6\u6D88\u201D\u7EE7\u7EED\u5F85\u5728\u6B64\u9875\u9762\u3002")) {
                        ...
                        trackConfirmationAnalytics("staying");
                ...
                trackConfirmationAnalytics("unhandled");
            }
        };

        function trackConfirmationAnalytics(action) {
            AJS.trigger("analytics", { name: "rte.quick-edit.confirmation." + action });
        }
