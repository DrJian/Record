...
set autoindent cindent cinoptions=g0 " 打开自动缩进和 C 语言风格的缩进模式，
                            		  " 定制 C 语言缩进风格
...
"-------------------------hongjian start----------------------------
map c ofile_put_contents('/tmp/hongjian', __FILE__.' '.__LINE__.'  '.PHP_EOL, FILE_APPEND);<ESC>F'1hi
map cv ofile_put_contents('/tmp/hongjian', __FILE__.' '.__LINE__.PHP_EOL.var_export($, true).PHP_EOL, FILE_APPEND);<ESC>F$1li
...
set t_ti= t_te= "vim推出后内容依然显示，避免误删
